...
## General
- **[<code>GET</code> Time Zones list](/general/GET_time_zone_list.md)**
- **[<code>GET</code> Plans list](/general/GET_plan_list.md)**
- **[<code>GET</code> Available Phone Numbers list](/general/GET_available_phone_number_list.md)**
